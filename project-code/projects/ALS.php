...
<html>
   ...
   <body>
      <header>
         ...
         <!-- Navbar -->
         <!-- Full Page Intro -->
         <div class="view jarallax" data-jarallax='{"speed": 0.5}' style="background-image: url('prodimg/Grupo 400.png'); height: 100%; background-position: center; background-repeat: no-repeat; background-size: cover;">
               ...
               <div class="container wecreate">
                  ...
                  <div class="row">
                     <div class="col-md-12 mb-4 white-text text-left">
                        <img class=" animate__animated animate__fadeInLeftBig  text-uppercase title h1 font-weight-bold text-left" src="prodimg/Grupo 401.png" alt="">
                     </div>
                     <!--Grid column-->
                     <!--Grid column-->
                  </div>
	...
	height:590px;
         ...
         <div class="row " style="z-index: 9;">
               ...
               <div class="row" style="margin-top: 32px;" >
                  <div class="col-md-12" >
                     <div class="row">
                        ...
                        <img src="prodimg/ALS/3.png" class="img-fluid rounded">
                        </a>
                        <a data-toggle="lightbox" data-gallery="example-gallery" class="animate__animated animate__fadeInDown col-sm-4">
                        <img src="prodimg/ALS/2.png" class="img-fluid rounded">
                        </a>
                        <a data-toggle="lightbox" data-gallery="example-gallery" class="animate__animated animate__fadeInDown col-sm-4">
                        <img src="prodimg/ALS/4.png"  class="img-fluid rounded">
                        </a>
                     </div>
                     <div class="row">
                        <a data-toggle="lightbox" data-gallery="example-gallery" class="animate__animated animate__fadeInDown col-sm-4">
                        ...
                        <a data-toggle="lightbox" data-gallery="example-gallery" class="animate__animated animate__fadeInDown col-sm-4">
                        <img src="prodimg/ALS/5.png"  class="img-fluid rounded">
                        </a>
                        <a data-toggle="lightbox" data-gallery="example-gallery" class="animate__animated animate__fadeInDown col-sm-4">
                        <img src="prodimg/ALS/6.png"  class="img-fluid rounded">
                        </a>
                     </div>
                     <div class="row">
                        <a data-toggle="lightbox" data-gallery="example-gallery" class="animate__animated animate__fadeInDown col-sm-4">
            ...
            <div class="col-lg-3 justify-content-start animate__animated animate__fadeInDown " style="top: 90px;">
               <p  style="color: black; " >A ALS Controlvet garante a segurança, autenticidade e controlo de qualidade dos mais variados serviços e setores de atividade. A ALS confia no nosso trabalho nas mais diversas áreas, que vão desde vídeos institucionais, a presenças em stands e feiras e ao desenvolvimento do seu mais recente produto, MyPetCare.</p>
               <p  style="color: black;" >My Pet care são centros veterinários que se dedica aos cuidados dos animais domésticos.</p>
            </div>
         </div>
      ...
      <div class="row" style="margin-top: 75px;">
         <div class="col-lg-2"></div>
         <div class="col-md-8" >
            <h4 data-aos="fade-up" data-aos-offset="250" style="color: #BEBF01;"> The new face </h4>
            <h1 data-aos="fade-up" class="font-weight-bold">DESIGN</h1>
            <br>
            <!--Carousel Wrapper-->
            <div data-aos="fade-up" data-aos-offset="400" id="carousel-example-1z" class="carousel slide carousel-fade" data-ride="carousel">
               ...
               <div class="carousel-inner rounded" role="listbox">
                  ...
                  <div class="carousel-item active ">
                     <img class="d-block w-100" src="prodimg/ALS/21.png"
                        alt="First slide">
                  </div>
                  <!--/First slide-->
                  <!--Second slide-->
                  <div class="carousel-item ">
                     <img class="d-block w-100" src="prodimg/ALS/31.png"
                        alt="Second slide">
                  </div>
                  <!--/Second slide-->
                  <!--Third slide-->
      ...
      <div>
         <div class="row" style="margin-top:100px !important; height:555px;">
            ...
            <div class="col-lg-8 justify-content-start">
               <div class="" data-aos="fade-right" style="z-index: 1; position: absolute;" >
                  <!--Carousel Wrapper-->
                  <div id="carousel-example-1z" class="carousel slide carousel-fade" data-ride="carousel" style="height: 555px;">
                     ...
                     <div class="carousel-inner rounded" role="listbox">
                        <!--First slide-->
                        <div class="carousel-item active">
                           <img class="d-block w-100" src="prodimg/ALS/61.png"
                              alt="First slide" style="height: 555px; max-width: 550px;">
                        </div>
                        <!--/First slide-->
                        <!--Second slide-->
                        <div class="carousel-item">
                           <img class="d-block w-180" src="prodimg/ALS/61.png"
               ...
               <div class="col-lg-4 col-md-12"  data-aos="fade-right" data-aos-offset="250" style="z-index: 9; top: 70px; left: 395px; max-width:600px;">
                  ...
                  <div class="card card-body" style="padding: 3.5rem;">
                     ...
                     <p class="text-justify" >Os nossos designers tentaram transmitir confiança apostando num design dinâmico e simples para ser compreendido por todos os seus clientes.  </p>
                  </div>
                  <!--/.Panel-->
               </div>
               <!-- Grid column -->
         ...
         <div class="row" style="margin-top:75px !important; height:555px;">
            ...
            <div class="col-lg-8 ">
               <div class="d-flex justify-content-end">
                  <div class="" data-aos="fade-left" style="z-index: 1; position: absolute;" >
                     <!--Carousel Wrapper-->
                     <div id="carousel-example-1z" class="carousel slide carousel-fade" data-ride="carousel" style="height: 555px;">
                        <!--Indicators-->
                        <ol class="carousel-indicators">
                        ...
                        <div class="carousel-inner rounded" role="listbox">
                           <!--First slide-->
                           <div class="carousel-item active">
                              <img class="d-block w-100" src="prodimg/ALS/41.png"
                                 alt="First slide" style="height: 555px; max-width: 550px;">
                           </div>
                           <!--/First slide-->
                           <!--Second slide-->
                           <div class="carousel-item">
                              <img class="d-block w-180" src="prodimg/ALS/55.png"
                                 alt="Second slide" style="height: 555px; max-width: 550px;">
                           </div>
                           <!--/Second slide-->
                           <!--Third slide-->
                           <div class="carousel-item">
                              <img class="d-block w-180" src="prodimg/ALS/41.png"
                                 alt="Third slide" style="height: 555px; max-width: 550px;">
                           </div>
                           <!--/Third slide-->
                        </div>
               ...
               <div class="d-flex justify-content-start" >
                  <div class="col-lg-8 col-md-12" data-aos="fade-left" data-aos-offset="250" style="z-index: 9; top: 70px; left: -13px; max-width:600px;">
                     <!--Panel-->
                     <div class="card card-body" style="padding: 3.5rem;">
                        <h4 class="font-weight-bold">WEB AND APP</h4>
                        <p class="text-justify" > O site foi desenvolvido como resultado da abordagem dos nossos designers. Criando a ponte de toda a transmissão de informação mais importante aos clientes da empresa. </p>
                     </div>
                     <!--/.Panel-->
                  </div>
                  <!-- Grid column -->
               ...
               <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                  <div class="modal-content">
                     <div class="embed-responsive embed-responsive-16by9 z-depth-1-half">
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/Mw1e8sDVUpk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                     </div>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-md-8 mx-auto mb-4">
                  <div class="view z-depth-1 rounded">
                     <img class="rounded img-fluid" src="prodimg/ALS/Grupo 418.png" alt="Video title">
