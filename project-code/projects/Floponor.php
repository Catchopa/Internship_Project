...
<html>
   ...
   <body>
      <header>
         ...
         <!-- Navbar -->
         <!-- Full Page Intro -->
         <div class="view jarallax" data-jarallax='{"speed": 0.5}' style="background-image: url('prodimg/Grupo 420.png'); height: 100%; background-position: center; background-repeat: no-repeat; background-size: cover;">
               ...
               <div class="container wecreate">
                  ...
                  <div class="row">
                     <div class="col-md-12 mb-4 white-text text-left">
                        <img class=" animate__animated animate__fadeInLeftBig  text-uppercase title h1 font-weight-bold text-left" src="prodimg/Grupo 421.png" alt="">
                     </div>
                     <!--Grid column-->
                     <!--Grid column-->
                  </div>
...
<div class="container-fluid">
         ...
         <div class="row " style="z-index: 9;">
               ...
               <div class="row" style="margin-top: 32px;" >
                  <div class="col-md-12" >
                     <div class="row">
                        ...
                        <img src="prodimg/Flopono/88879.png" class="img-fluid rounded">
                        </a>
                        <a data-toggle="lightbox" data-gallery="example-gallery" class="animate__animated animate__fadeInDown col-sm-4">
                        <img src="prodimg/Flopono/88876.png" class="img-fluid rounded">
                        </a>
                        <a data-toggle="lightbox" data-gallery="example-gallery" class="animate__animated animate__fadeInDown col-sm-4">
                        <img src="prodimg/Flopono/88877.png"  class="img-fluid rounded">
                        </a>
                     </div>
                     <div class="row">
                        <a data-toggle="lightbox" data-gallery="example-gallery" class="animate__animated animate__fadeInDown col-sm-4">
            ...
            <div class="col-lg-3 justify-content-start animate__animated animate__fadeInDown " style="top: 90px;">
               <p style="color: white; " >A FLOPONOR é um grupo empresarial diversificado, consolidada em três áreas de negócio – Floresta, Ambiente e Construção - visando o crescimento contínuo nas áreas em que atua.</p>
            </div>
         </div>           
            ...
            <div class="row" style="margin-top: 75px;">
               <div class="col-lg-2"></div>
               <div class="col-md-8" >
                  <h4 data-aos="fade-up" data-aos-offset="250" style="color: #028F3A;"> Final Product </h4>
                  <h1 data-aos="fade-up" class="font-weight-bold">WEB SITE</h1><br>
                     ...
                     <div class="carousel-inner rounded" role="listbox">
                        ...
                        <div class="carousel-item active ">
                           <img class="d-block w-100" src="prodimg/Flopono/88878.png"
                           alt="First slide">
                        </div>
                        <!--/First slide-->
                        <!--Second slide-->
                  ...
                  <div class="col-lg-8 justify-content-start">
                     <div class="" data-aos="fade-right" style="z-index: 1; position: absolute;" ><!--Carousel Wrapper-->
                        ...
                        <div class="carousel-inner rounded" role="listbox">
                           <!--First slide-->
                           <div class="carousel-item active">
                              <img class="d-block w-100" src="prodimg/Flopono/8887612.png"
                              alt="First slide" style="height: 555px; max-width: 550px;">
                           </div>
                           <!--/First slide-->
                           <!--Second slide-->
                           <div class="carousel-item">
                              <img class="d-block w-180" src="prodimg/Flopono/888761.png"
                              alt="Second slide" style="height: 555px; max-width: 550px;">
                           </div>
                           <!--/Second slide-->
                           <!--Third slide-->
                           <div class="carousel-item">
                              <img class="d-block w-180" src="prodimg/Flopono/8887612.png"
