...
<html>
   ...
   <body>
      <header>
         ...
         <!-- Navbar -->
         <!-- Full Page Intro -->
         <div class="view jarallax" data-jarallax='{"speed": 0.5}' style="background-image: url('prodimg/Grupo 398.png'); height: 100%; background-position: center; background-repeat: no-repeat; background-size: cover;">
               ...
               <div class="container wecreate">
                  ...
                  <div class="row">
                     <div class="col-md-12 mb-4 white-text text-left">
                        <img class=" animate__animated animate__fadeInLeftBig  text-uppercase title h1 font-weight-bold text-left" src="prodimg/Grupo 399.png" alt="">
                     </div>
                     <!--Grid column-->
                     <!--Grid column-->
                  </div>
	...
	height:588px;
         ...
         <div class="row " style="z-index: 9;">
               ...
               <div class="row" style="margin-top: 32px;" >
                  <div class="col-md-12" >
                     <div class="row">
                        ...
                        <a data-toggle="lightbox" data-gallery="example-gallery" class="animate__animated animate__fadeInDown col-sm-4">
                        <img src="prodimg/CDT/post.png" class="img-fluid rounded">
                        </a>
                        <a data-toggle="lightbox" data-gallery="example-gallery" class="animate__animated animate__fadeInDown col-sm-4">
                        <img src="prodimg/CDT/free-a4-paper-mockup-2.png"  class="img-fluid rounded">
                        </a>
                     </div>
                     <div class="row">
                        <a data-toggle="lightbox" data-gallery="example-gallery" class="animate__animated animate__fadeInDown col-sm-4">
                        ...
                        <a data-toggle="lightbox" data-gallery="example-gallery" class="animate__animated animate__fadeInDown col-sm-4">
                        <img src="prodimg/CDT/InicioJogo.png"  class="img-fluid rounded">
                        </a>
                     </div>
                     <div class="row">
                        <a data-toggle="lightbox" data-gallery="example-gallery" class="animate__animated animate__fadeInDown col-sm-4">
            ...
            <div class="col-lg-3 justify-content-start animate__animated animate__fadeInDown " style="top: 90px;">
               <p style="color: white; " >O Clube Desportivo do Tondela é o único clube do distrito de Viseu a jogar na Liga NOS. Enche-nos de orgulho acompanhar este clube na Primeira Liga e mostrar o árduo trabalho que desenvolve para ser cada vez melhor. </p>
               <p style="color: white;" >A paixão da equipa-família pelo futebol só torna este trabalho ainda mais desafiante e divertido. Para toda a equipa a publicidade sempre foi um ponto crucial para a divulgação do clube assim conseguimos inovar e 
                     distinguir-nos pela qualidade do nosso Design, Vídeo e Comunicação.</p>
            </div>
         </div>         
            ...
            <div class="row" style="margin-top: 75px;">
               <div class="col-lg-2"></div>
               <div class="col-md-8" >
                  <h4 data-aos="fade-up" data-aos-offset="250" style="color: #018D36;"> A tua paixão está de volta </h4>
                  <h1 data-aos="fade-up" class="font-weight-bold">COMUNICAÇÃO</h1><br>
                     <!--Carousel Wrapper-->
                     ...
                     <div class="carousel-inner rounded" role="listbox">
                        ...
                        <div class="carousel-item active">
                           <img class="d-block w-100" src="prodimg/CDT/22.png"
                           alt="First slide">
                        </div>
                        <!--/First slide-->
                        <!--Second slide-->
                  ...
                  <div class="col-lg-8 justify-content-start">
                     <div class="" data-aos="fade-right" style="z-index: 1; position: absolute;" ><!--Carousel Wrapper-->
                        ...
                        <div class="carousel-inner rounded " role="listbox">
                           <!--First slide-->
                           <div class="carousel-item active">
                              <img class="d-block w-100" src="prodimg/CDT/33.png"
                              alt="First slide" style="height: 555px; max-width: 550px;">
                           </div>
                           <!--/First slide-->
                           <!--Second slide-->
                           <div class="carousel-item">
                              <img class="d-block w-180" src="prodimg/CDT/33.png"
                     ...
                     <div class="col-lg-4 col-md-12"  data-aos="fade-right" data-aos-offset="250" style="z-index: 9; top: 70px; left: 395px; max-width:600px;">
                        ...
                        <div class="card card-body" style="padding: 3.5rem;">
                           ...
                           <p class="text-justify" > Calendário 2016/2017 </p>
                        </div>
                        <!--/.Panel-->
                     </div>
                     <!-- Grid column -->
                  ...
                  <div class="col-lg-8 ">
                     ...
                     <div class="" data-aos="fade-left" style="z-index: 1; position: absolute;" ><!--Carousel Wrapper-->
                        ...
                        <div class="carousel-inner rounded" role="listbox">
                           <!--First slide-->
                           <div class="carousel-item active">
                              <img class="d-block w-100" src="prodimg/CDT/44.png"
                              alt="First slide" style="height: 555px; max-width: 550px;">
                           </div>
                           <!--/First slide-->
                           <!--Second slide-->
                           <div class="carousel-item">
                              <img class="d-block w-180" src="prodimg/CDT/44.png"
                              alt="Second slide" style="height: 555px; max-width: 550px;">
                           </div>
                           <!--/Second slide-->
                           <!--Third slide-->
      ...
      <div class="d-flex justify-content-start" >
                     <div class="col-lg-8 col-md-12" data-aos="fade-left" data-aos-offset="250" style="z-index: 9; top: 70px; left: -13px; max-width:600px;">
                        <!--Panel-->
                        <div class="card card-body" style="padding: 3.5rem;">
                           <h4 class="font-weight-bold">COMUNICAÇÃO</h4>
            ...
            <div class="modal fade" id="modal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
               ...
               <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                  <div class="modal-content">
                     ...
                     <iframe width="560" height="315" src="https://www.youtube.com/embed/vrHSmJCxjwM" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                     </div>
                  </div>
               </div>
            </div>
           <div class="row">
               <div class="col-md-8 mx-auto mb-4">
                  <div class="view z-depth-1 rounded">
                     <img class="rounded img-fluid" src="prodimg/CDT/Grupo 410.png" alt="Video title">
